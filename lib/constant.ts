...
export const DOGRAH_WORKFLOW_ID =
    process.env.NEXT_PUBLIC_DOGRAH_WORKFLOW_ID!;
...
// These names are used by the Bookified UI.
...
export const CLERK_AUTH_APPEARANCE_OVERRIDE = {
    ...
    card:
        'shadow-none border-none rounded-xl bg-transparent',

    headerTitle:
        '!text-2xl font-bold text-[#212a3b]',

    headerSubtitle:
        '!mt-3 !text-sm text-[#3d485e]',
    ...
    formFieldLabel:
        'text-[#212a3b] font-medium text-lg',
